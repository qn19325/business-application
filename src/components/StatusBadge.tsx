...
type Display = { color: string; label: string };

const taxReturnStatusDisplay: Record<Status, Display> = {
...
const mtdSubmissionStatusDisplay: Record<MtdSubmissionStatus, Display> = {
